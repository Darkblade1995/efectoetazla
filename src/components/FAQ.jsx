...
const preguntas = [
  {
    ...
    a: 'Es una plataforma digital de lectura y reflexión donde la palabra construye conciencia. Ofrecemos contenido original y un espacio editorial para escritores.',
    lista: null,
  },
  {
        ...
        <div className="faq__lista-preguntas">
          {preguntas.map((item, i) => (
            ...
            >
              ...
              >
                <span className="faq__numero">
                  {i + 1}.
                </span>

                <span className="faq__pregunta-texto">
                  {item.q}
                </span>
